...
?><html>
    ...
    <meta name=”viewport” content=”width=device-width, initial-scale=1″>  <!-- Makes the page fit the device with, makes the website at least slightly more mobile friendly -->
        <a href="<?php echo $link; ?>/Main-Page.php">Back to Main Page</a></br>  <!-- Hyperlink to Main-Page.php, the Main Page of the Web Server -->
        <iframe width="1050" height="812" src="https://www.crazygames.com/embed/bitcoiner" frameborder="0" allowfullscreen></iframe>  <!-- iframe of the Bitcoiner game from Crazygames -->
